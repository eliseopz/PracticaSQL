...
insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (010, N'000033466', N'Josias', N'Perez', '03/04/2007', N'jperez@est.uca.edu.ni', N'85536141', N'ISI')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (011, N'000052467', N'Jose', N'Duran', '03/14/2007', N'jduran@est.uca.edu.ni', N'85516241', N'ISI')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (012, N'000051354', N'Jazmin', N'Munoz', '12/24/1992', N'jazmin@est.uca.edu.ni', N'85534561', N'CIVIL')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (013, N'000021354', N'Cristel', N'Muniz', '11/04/1995', N'cristel@est.uca.edu.ni', N'85524511', N'CIVIL')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (014, N'000021314', N'Cristian', N'Muniz', '11/04/1995', N'cristel@est.uca.edu.ni', N'85524511', N'CIVIL')
go

insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (015, N'000021324', N'Allison', N'Mendez', '10/14/1999', N'allison@est.uca.edu.ni', N'55524511', N'CIVIL')
go
...
insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (033, N'000026741', N'Uriel', N'Castro', '09/07/2001', N'urielcastro@est.uca.edu.ni', N'53326992', N'ARQUITECTURA')
go
...
insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (035, N'000023894', N'Jose', N'Castillo', '10/08/2004', N'josecastillo@est.uca.edu.ni', N'83297992', N'ARQUITECTURA')
go
...
insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (038, N'000037854', N'Jorge', N'Garcia', '05/08/2001', N'jorgegarcia@est.uca.edu.ni', N'53691871', N'ARQUITECTURA')
go
...
insert into Estudiantes(ID_estudiante, IDUCA, Nombre, Apellido, FechaNac, Correo_electronico, Telefono, Carrera) 
values (040, N'000027812', N'Elsner', N'Gonzales', '05/12/1998', N'elsner@est.uca.edu.ni', N'53693871', N'ARQUITECTURA')
go
...
insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (002, N'B102', N'Calculo 1', N'Martes 5 p.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (003, N'B103', N'Metpro', N'Martes 3 p.m')
go
...
insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (006, N'B106', N'Algebra Lineal', N'Jueves 10 a.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (007, N'B107', N'Matematica discreta', N'Jueves 11 a.m')
go

insert into Clases(ID_clase, Codigo_clase, Nombre_clase, Horario) values (008, N'B108', N'Calculo 2', N'Lunes 11 a.m')
go
...
--Agregar activo a clases
alter table Clases add Activo bit default 'true'

--Eliminar tablas Monitores y Estudiantes
